                    ...
                    <Row className={'justify-content'}>
                        <Col className={'col-4 offset-1 col-sm-2'}>
                            ...
                            <ul className="list-unstyled">
                                <li><Link to={"/confusion/home"}>Home</Link></li>
                                <li><Link to={"/confusion/aboutus"}>About</Link></li>
                                <li><Link to={"/confusion/menu"}>Menu</Link></li>
                                <li><Link to={"/confusion/contactus"}>Contact us</Link></li>
                            </ul>
                        </Col>
